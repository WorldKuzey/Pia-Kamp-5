  ...
  return (
    <div className="flex gap-8 p-6 bg-white rounded-xl">
      <div className="flex-1 space-y-4">
        <header
          className="text-center py-4 font-bold text-2xl"
        ...
        <div style={{ fontFamily: "Comic Sans MS, cursive, sans-serif" }}>
          <p style={{ textAlign: "justify" }}>
            We understand that sometimes, it's hard to share personal thoughts
            or challenges openly at work. This space is here for you to express
            yourself freely and anonymously, without fear of judgment. Whether
            it's a small frustration, a big idea, or something you’ve been
            holding onto, your confession matters. It’s a safe place to be
            heard. Take a moment to reflect and let your voice be part of
            creating a more open, supportive workplace. We’re here to listen.
          </p>
        </div>
        <div
        ...
        >
          <button
            type="button"
            onClick={() =>
              handleSubmit(nickname, confession, interval, department)
            }
            className="rounded-[5px] border-[2px] border-[#4bc959] text-[#0d0000] bg-[#afedb7] px-6 py-2"
          >
            SUBMIT
